...
class Vector2dTest {
    ...
    void upperRight(){
        ...
        assertEquals(new Vector2d(0,1), v1.upperRight(v2));
        assertEquals(new Vector2d(1,1),v3.upperRight(v1));
    }
    @Test
    void lowerLeft(){
        Vector2d v1 = new Vector2d(0,0);
        ...
        assertEquals(new Vector2d(-2,0), v1.lowerLeft(v2));
        assertEquals(new Vector2d(0,0),v3.lowerLeft(v1));
    }
    @Test
    void add(){
        Vector2d v1 = new Vector2d(0,0);
